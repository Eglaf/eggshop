 ...
 */
class Version20180215164630 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE content_text (id INT AUTO_INCREMENT NOT NULL, code CHAR(128) NOT NULL, title CHAR(255) DEFAULT NULL, text LONGTEXT NOT NULL, enabled_parameters LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:simple_array)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
