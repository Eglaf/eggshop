 ...
 */
class Version20180219012012 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE user_user (id INT AUTO_INCREMENT NOT NULL, name CHAR(64) NOT NULL, email CHAR(128) NOT NULL, phone CHAR(32) DEFAULT NULL, password CHAR(64) NOT NULL, role CHAR(32) NOT NULL, active TINYINT(1) NOT NULL, activation_hash CHAR(16) DEFAULT NULL, UNIQUE INDEX UNIQ_F7129A80E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
