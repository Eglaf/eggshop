 ...
 */
class Version20180208143503 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE content_text (id INT AUTO_INCREMENT NOT NULL, code CHAR(128) NOT NULL, title CHAR(255) DEFAULT NULL, text LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE simpleshop_product (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, active TINYINT(1) NOT NULL, label CHAR(128) NOT NULL, description CHAR(255) DEFAULT NULL, price INT NOT NULL, INDEX IDX_7EA9B56712469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
